                ...
                <div class="card-body">
                    <form action="<?php echo URLROOT; ?>/users/edit/<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <div id="preview-container" class="mb-2">
                                            <?php 
                                            $imgSrc = URLROOT . '/public/assets/img/default-user.png';
                                            if(!empty($data['profile_image']) && $data['profile_image'] != 'default.png'){
                                                $imgSrc = URLROOT . '/public/uploads/users/' . $data['profile_image'];
                                            }
                                            ?>
                                            <img id="photo-preview" src="<?php echo $imgSrc; ?>" class="img-thumbnail" style="max-width: 200px; display:block;">
                                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <a href="<?php echo URLROOT; ?>/users/index" class="btn btn-secondary shadow-sm w-100 mt-2">Cancelar</a>
                        </div>
                    </form>
